    ...
    def run(self, gameDisplay, info):
        ...
        while not self.crashed:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN and f1 == 0:
                    jump.play(0)
                    f1 = 1
                    m1 = 1  # start moving

                if event.type == pygame.KEYDOWN and f2 == 0:
                    jump.play(0)
                    f2 = 1
                    m2 = 1  # start moving

                if event.type == pygame.KEYDOWN and f3 == 0:
                    jump.play(0)
                    f3 = 1
                    m3 = 1  # start moving
                ...
                if event.type == pygame.KEYDOWN and f4 == 0:
                    jump.play(0)
                    f4 = 1
                    m4 = 1  # start moving

                if event.type == pygame.KEYDOWN and f5 == 0:
                    jump.play(0)
                    f5 = 1
                    m5 = 1  # start moving

                if event.type == pygame.KEYDOWN and f6 == 0:
                    jump.play(0)
                    f6 = 1
                    m6 = 1
